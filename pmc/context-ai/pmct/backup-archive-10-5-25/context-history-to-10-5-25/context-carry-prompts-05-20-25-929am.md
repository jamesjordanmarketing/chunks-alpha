...
pmc/system/plans/context-carries/context-carry-info-05-20-25-929am.md
...
You are not going to execute the below. Your task is to update: pmc/system/plans/context-carries/context-carry-info-05-20-25-929am.md with the details of what I am requesting below:

We are goind to audit the test results from: pmc\core\active-task-unit-tests-qa-agent.md

Questions we will ask the next chat window:
1. Did the ai testing agent view the screenshots for correct implementation.
2. Did the ai testing agent read the images using AI to determine if they were successful.
3. It says the code was completed but I don't see any actual components in the screenshots.

In the next carryover file: pmc/system/plans/context-carries/context-carry-info-05-20-25-929am.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc/system/plans/context-carries/context-carry-info-05-20-25-929am.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc/system/plans/context-carries/context-carry-info-05-20-25-929am.md
