...
pmc/system/plans/context-carries/context-carry-info-08-28-25-856pm.md
...
You are not going to execute the below. Your task is to update: pmc/system/plans/context-carries/context-carry-info-08-28-25-856pm.md with the details of what I am requesting below:

CONTENT

In the next carryover file: pmc/system/plans/context-carries/context-carry-info-08-28-25-856pm.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc/system/plans/context-carries/context-carry-info-08-28-25-856pm.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc/system/plans/context-carries/context-carry-info-08-28-25-856pm.md
