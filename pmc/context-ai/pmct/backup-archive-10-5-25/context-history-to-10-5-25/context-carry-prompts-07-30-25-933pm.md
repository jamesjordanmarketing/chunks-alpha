...
pmc\system\plans\context-carries\context-carry-info-07-30-25-933pm.md
...
You are not going to execute the below. Your task is to update: pmc\system\plans\context-carries\context-carry-info-07-30-25-933pm.md with the details of what I am requesting below:

The next active development focus is engineering the front ends for the content analysis module. The first thing we will work on is implementing the pages described here:
pmc\product\_front-end
Read them all then create brief plan and specification for how to implement them.

In the next carryover file: pmc\system\plans\context-carries\context-carry-info-07-30-25-933pm.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc\system\plans\context-carries\context-carry-info-07-30-25-933pm.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc\system\plans\context-carries\context-carry-info-07-30-25-933pm.md
