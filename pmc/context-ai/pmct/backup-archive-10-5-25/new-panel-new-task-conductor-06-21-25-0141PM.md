...
1.  **Generate Task Approach:**
    ...
    *   Read the file system\plans\new-panels\new-task-carry-context-06-21-25-0141PM.md for relevant context from the task test finished just before this one.
...
Put the updated conductor prompt in system\plans\new-panels\04-new-task-carry-conductor-output-06-21-25-0141PM.md
