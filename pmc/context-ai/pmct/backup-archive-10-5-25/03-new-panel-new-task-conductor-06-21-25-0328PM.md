...
1.  **Generate Task Approach:**
    ...
    *   Read the file system\plans\new-panels\02-new-task-carry-context-06-21-25-0328PM.md for relevant context from the task test finished just before this one.
