...
- 📄 Path to the new task file: system\plans\new-tests\01-new-test-carry-prompt-09-15-25-0557PM.md
- 📄 Path to the new conductor file: system\plans\new-tests\04-new-test-conductor-prompt-09-15-25-0557PM.md
...
system\plans\new-tests\02-new-test-carry-context-09-15-25-0557PM.md and system\plans\new-tests\03-new-test-active-test-2-enhanced-09-15-25-0557PM.md
...
Execute the test conductor prompt in system\plans\new-tests\04-new-test-conductor-prompt-09-15-25-0557PM.md to customize the new test conductor prompt. 
Wait for 20 seconds to make sure the prompt has finished executing. 

Check that the output in system\plans\new-tests\05-new-test-conductor-output-09-15-25-0557PM.md  
...
## Next Steps
The human will copy the system\plans\new-tests\05-new-test-conductor-output-09-15-25-0557PM.md prompt into the next ai testing agent panel.
