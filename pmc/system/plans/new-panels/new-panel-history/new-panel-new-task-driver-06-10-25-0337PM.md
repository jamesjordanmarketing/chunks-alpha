...
system\plans\new-panels\new-panel-new-task-driver-06-10-25-0337PM.md
...
You are not going to execute the below. Your task is to update: system\plans\new-panels\new-panel-new-task-driver-06-10-25-0337PM.md with the details of what I am requesting below:

CONTENT

In the next carryover file: system\plans\new-panels\new-panel-new-task-driver-06-10-25-0337PM.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `system\plans\new-panels\new-panel-new-task-driver-06-10-25-0337PM.md` carefully
