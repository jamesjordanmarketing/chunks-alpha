...
```bash
node bin\aplio-agent-cli.js start-task "T-3.1.1"
...
- 📄 Path to the new task file: system\plans\new-panels\01-new-panel-new-task-07-01-25-0845PM.md
- 📄 Path to the new conductor file: system\plans\new-panels\03-new-panel-new-task-conductor-07-01-25-0845PM.md
...
The human will copy the system\plans\new-panels\04-new-panel-new-task-conductor-output-07-01-25-0845PM.md into the next ai testing agent panel.