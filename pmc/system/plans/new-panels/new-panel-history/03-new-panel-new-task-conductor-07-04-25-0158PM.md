...
1.  **Generate Task Approach:**
    ...
    *   Read the file system\plans\new-panels\02-new-task-carry-context-07-04-25-0158PM.md for relevant context from the task test finished just before this one.
...
Is this task implementation conductor prompt enough? too much? please optimize it for the next ai implementation agent and put it in the output file: system\plans\new-panels\04-new-panel-new-task-conductor-output-07-04-25-0158PM.md


Based on the current pmc\core\active-task.md file and the carry over context in system\plans\new-panels\02-new-task-carry-context-07-04-25-0158PM.md
Is this enough? too much? please optimize it for the next ai implementation agent who must implement T-3.1.4
