...
```bash
node bin\aplio-agent-cli.js start-task "T-3.3.3"
...
- 📄 Path to the new task file: system\plans\new-panels\01-new-panel-new-task-07-14-25-1022AM.md
- 📄 Path to the new conductor file: system\plans\new-panels\03-new-panel-new-task-conductor-07-14-25-1022AM.md
...
Check that the output in system\plans\new-panels\04-new-panel-new-task-conductor-output-07-14-25-1022AM.md 
has been updated with content relevant to this task and test.
...
The human will copy the system\plans\new-panels\04-new-panel-new-task-conductor-output-07-14-25-1022AM.md into the next ai testing agent panel.