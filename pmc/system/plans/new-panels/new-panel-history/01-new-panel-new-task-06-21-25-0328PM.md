...
First read: system\plans\new-panels\02-new-task-carry-context-06-21-25-0328PM.md to understand how to update it correctly. Remove any sections not used.
...
One more reminder. Your job is ONLY to update system\plans\new-panels\02-new-task-carry-context-06-21-25-0328PM.md with an in depth context build of all of the information it will need to fully analyze the prompts document.