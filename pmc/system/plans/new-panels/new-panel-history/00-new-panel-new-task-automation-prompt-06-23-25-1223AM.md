...
The Human must execute the start-task command for the next task FIRST. Then the human must execute the New Panel Automation Script before pasting this prompt into the chat panel.
```bash
...
- 📄 Path to the new task file: system\plans\new-panels\01-new-panel-new-task-06-23-25-1223AM.md
- 📄 Path to the new conductor file: system\plans\new-panels\03-new-panel-new-task-conductor-06-23-25-1223AM.md
...
Check that the output in system\plans\new-panels\04-new-panel-new-task-conductor-output-06-23-25-1223AM.md 
has been updated with content relevant to this task and test.
...
The human will copy the system\plans\new-panels\04-new-panel-new-task-conductor-output-06-23-25-1223AM.md into the next ai testing agent panel.