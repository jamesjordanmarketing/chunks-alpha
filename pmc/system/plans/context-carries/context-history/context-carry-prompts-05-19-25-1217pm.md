...
pmc/system/plans/context-carries/context-carry-info-05-19-25-1217pm.md
...
You are not going to execute the below. Your task is to update: pmc/system/plans/context-carries/context-carry-info-05-19-25-1217pm.md with the details of what I am requesting below:

We need to check on task T-1.1.1 as defined in:
pmc\core\active-task.md
and
pmc\core\active-task-unit-tests.md

please tell me if these are complete in aplio-modern-1

In the next carryover file: pmc/system/plans/context-carries/context-carry-info-05-19-25-1217pm.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc/system/plans/context-carries/context-carry-info-05-19-25-1217pm.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc/system/plans/context-carries/context-carry-info-05-19-25-1217pm.md
