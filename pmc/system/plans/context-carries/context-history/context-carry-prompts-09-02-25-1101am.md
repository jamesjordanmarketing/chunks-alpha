...
pmc/system/plans/context-carries/context-carry-info-09-02-25-1101am.md
...
You are not going to execute the below. Your task is to update: pmc/system/plans/context-carries/context-carry-info-09-02-25-1101am.md with the details of what I am requesting below:

ok. now we need to make a few changes to the script file: pmc\product\_tools\02-generate-user-journey-prompt-segments_v3.js

Change 1: 
Read the input file: pmc\product\03.5-bmo-user-journey.md carefully.

You will see that it has these sections:
### Journey Scope and Boundaries
### Success Definition
### Value Progression Story for Proof-of-Concept
## User Persona Definitions (and all persona definition subsections)

These sections are not useful or helpful and need to be removed from the stage specific output files. The easiest string matching is probably to remove all content between the strings 
"### Journey Scope and Boundaries" (INCLUDING remove that string)
and 
"## 1. Discovery & Project Initialization" (DON"T remove that string)
The script: pmc\product\_tools\02-generate-user-journey-prompt-segments_v3.js needs to be updated to make that happen.


In the next carryover file: pmc/system/plans/context-carries/context-carry-info-09-02-25-1101am.md write a spec to get this done. Delete any sections which are not relevant.
...
## 4. Review Process
- Read each section of `pmc/system/plans/context-carries/context-carry-info-09-02-25-1101am.md` carefully
...
1. A summary of the active development context as you understand it from reading the: ## Active Development Focus section of the pmc/system/plans/context-carries/context-carry-info-09-02-25-1101am.md
